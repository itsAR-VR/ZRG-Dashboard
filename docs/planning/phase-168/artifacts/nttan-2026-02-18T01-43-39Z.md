# NTTAN Validation Evidence — 2026-02-18T01-43-39Z
...
2. `npm run test:ai-replay -- --client-id ef824aca-a3c9-4cde-b51f-2e421ebb6b6e --dry-run --limit 20`
   - result: pass
   - artifact: `.artifacts/ai-replay/run-2026-02-18T01-43-34-338Z.json`
3. `npm run test:ai-replay -- --client-id ef824aca-a3c9-4cde-b51f-2e421ebb6b6e --limit 20 --concurrency 3`
   - result: pass
   - artifact: `.artifacts/ai-replay/run-2026-02-18T01-43-39-339Z.json`
...
## Failure Types (from replay summary)
- decision_error: 0
- draft_generation_error: 0
- draft_quality_error: 1
- judge_error: 0
